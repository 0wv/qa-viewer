...
<div class="bg-indigo-50 leading-loose p-2 pt-4 rounded-2xl shadow">
  <span class="bg-indigo-200 font-bold px-4 py-2 rounded-2xl shadow-inner">答えを入力してください</span>
  {#if qa.type === 'fill'}
  <ul class="mt-2">
  ...
  <input
    ...
    class="bg-indigo-100 mt-4 border-0 px-4 py-2 rounded-2xl shadow-inner w-full"
    type="text"
  >
  {/if}
</div>
